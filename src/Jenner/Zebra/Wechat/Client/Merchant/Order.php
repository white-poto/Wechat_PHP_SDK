...
class Order extends Merchant
{
    ...
    {
        $uri = $this->uri_prefix . WechatUri::MERCHANT_ORDER_GET_BY_ID;
    ...
    {
        $uri = $this->uri_prefix . WechatUri::MERCHANT_ORDER_GET_BY_FILTER;
        $params = [
            'status' => $status,
    ...
    {
        $uri = $this->uri_prefix . WechatUri::MERCHANT_ORDER_SET_DELIVERY;
    ...
    {
        $uri = $this->uri_prefix . WechatUri::MERCHANT_ORDER_CLOSE;
        return $this->request_post($uri, ['order_id' => $order_id]);
    }
} 