...
class Shelf extends WechatClient
{
    ...
    {
        $uri = $this->uri_prefix . WechatUri::MERCHANT_SHELF_ADD;
    ...
    {
        $uri = $this->uri_prefix . WechatUri::MERCHANT_SHELF_DEL;
    ...
    {
        $uri = $this->uri_prefix . WechatUri::MERCHANT_SHELF_MOD;
        return $this->request_post($uri, $shelf);
    }
    ...
    {
        $uri = $this->uri_prefix . WechatUri::MERCHANT_SHELF_GET_ALL;
    ...
    {
        $uri = $this->uri_prefix . WechatUri::MERCHANT_SHELF_GET_BY_ID;
        return $this->request_post($uri, compact('shelf_id'));
    }
} 