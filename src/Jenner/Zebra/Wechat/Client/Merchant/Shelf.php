...
class Shelf extends BaseMerchant
{
    ...
    {
        $uri = $this->uri_prefix . WechatConfig::MERCHANT_SHELF_ADD;
    ...
    {
        $uri = $this->uri_prefix . WechatConfig::MERCHANT_SHELF_DEL;
    ...
    {
        $uri = $this->uri_prefix . WechatConfig::MERCHANT_SHELF_MOD;
        return $this->request_post($uri, $shelf);
    }
    ...
    {
        $uri = $this->uri_prefix . WechatConfig::MERCHANT_SHELF_GET_ALL;
    ...
    {
        $uri = $this->uri_prefix . WechatConfig::MERCHANT_SHELF_GET_BY_ID;
        return $this->request_post($uri, compact('shelf_id'));
    }
} 