...
class Order extends AbstractMerchant
{
    ...
    {
        $uri = $this->merchant_uri_prefix . URI::MERCHANT_ORDER_GET_BY_ID;
    ...
    {
        $uri = $this->merchant_uri_prefix . URI::MERCHANT_ORDER_GET_BY_FILTER;
    ...
    {
        $uri = $this->merchant_uri_prefix . URI::MERCHANT_ORDER_SET_DELIVERY;
    ...
    {
        $uri = $this->merchant_uri_prefix . URI::MERCHANT_ORDER_CLOSE;
        return $this->request_post($uri, ['order_id' => $order_id]);
    }
} 