...
class Category extends AbstractMerchant
{
    ...
    {
        $uri = $this->merchant_uri_prefix . WechatConfig::MERCHANT_CATEGORY_GET_SUB;
    ...
    {
        $uri = $this->merchant_uri_prefix . WechatConfig::MERCHANT_CATEGORY_GET_SKU;
        return $this->request_post($uri, ['cate_id' => $category_id]);
    }
    ...
    {
        $uri = $this->merchant_uri_prefix . WechatConfig::MERCHANT_CATEGORY_GET_PROPERTY;
        return $this->request_post($uri, ['cate_id' => $category_id]);
    }
