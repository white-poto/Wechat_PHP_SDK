...
class Code extends AbstractCard
{
    ...
    {
        $uri = $this->card_uri_prefix . URI::CARD_CODE_CONSUME;
    ...
    {
        $uri = $this->card_uri_prefix . URI::CARD_CODE_DECRYPT;
    ...
    {
        $uri = $this->card_uri_prefix . URI::CARD_CODE_GET;
    ...
    {
        $uri = $this->card_uri_prefix . URI::CARD_CODE_BATCH_GET;
    ...
    {
        $uri = $this->card_uri_prefix . URI::CARD_CODE_UPDATE;
    ...
    {
        $uri = $this->card_uri_prefix . URI::CARD_CODE_UNAVAILABLE;
        $params['code'] = $code;
